                ...
                <AnimationContainer delay={0.1}>
                    <div className="flex flex-col items-start justify-start md:max-w-[200px]">
                        ...
                        <span className="mt-4 text-neutral-200 text-sm flex items-center">
                            Made by <Link href="https://shreyas-sihasane.vercel.app/" className="font-semibold ml-1">Dipro Team</Link>
                        </span>
                    </div>
                </AnimationContainer>
            ...
            <div className="mt-8 border-t border-border/40 pt-4 md:pt-8 md:flex md:items-center md:justify-between w-full">
                <AnimationContainer delay={0.6}>
                    <p className="text-sm text-muted-foreground mt-8 md:mt-0">
                        &copy; {new Date().getFullYear()} Dipro INC. All rights reserved.
                    </p>
                </AnimationContainer>
            </div>

            <div className="h-[15rem] lg:h-[15rem] hidden md:flex items-center justify-center">
                <TextHoverEffect text="DIPROXULS" />
            </div>
        </footer>
    )
}
