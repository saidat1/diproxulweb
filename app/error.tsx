    ...
    <div className="min-h-screen bg-gradient-to-r from-green-200 to-gray-200 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 text-center">
        <div className="mb-8">
          ...
          <p className="mt-2 text-3xl font-bold text-gray-900 dark:text-gray-100">Internal Server Error</p>
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Oops! Something went wrong on our end. We're working on it.</p>
        </div>
        <div className="mt-8">
          <Link href="/"
