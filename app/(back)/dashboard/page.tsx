...
const revenueData = [
  { name: "KinderK", value: 1500000 },
  { name: "Primary", value: 400000 },
  { name: "High", value: 800000 },
  { name: "College", value: 920000 },
  { name: "University", value: 130000 },
  { name: "TVET", value: 500000 },
];
    ...
    <div className="flex-1 space-y-4 p-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">3,108,060</div>
                <Button
                  variant="link"
                  className="px-0 text-xs text-muted-foreground"
                >
